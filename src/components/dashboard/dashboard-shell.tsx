  ...
  <span>{item.label}</span>
            ...
            <main className="flex-1 p-4 sm:p-6">
              ...
              <div className="mt-6 space-y-6">
                <KpiCards data={dashboardData.kpiData} loading={isLoading} />
                <div className="grid gap-6 xl:grid-cols-[1.2fr_0.95fr]">
                  <LeadQualityChart data={dashboardData.qualityDistribution} loading={isLoading} />
                  <AIInsightsPanel insights={dashboardData.insights} loading={isLoading} />
                </div>
                <div className="grid gap-6 xl:grid-cols-[1.6fr_1fr]">
                  <LeadsAreaChart data={dashboardData.leadsByDay} loading={isLoading} />
                  <DealFunnel stages={dashboardData.funnelStages} loading={isLoading} />
                </div>
                <div className="grid gap-6 xl:grid-cols-[1.4fr_1fr]">
                  <RecentLeadsTable data={dashboardData.recentLeads} loading={isLoading} />
                  <WorkflowTimeline items={dashboardData.workflowTimeline} loading={isLoading} />
                </div>
                <PerformanceSection metrics={dashboardData.performanceMetrics} loading={isLoading} />
              </div>
            </main>
          </div>
        </div>
